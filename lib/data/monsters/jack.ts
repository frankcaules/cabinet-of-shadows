...
export const jack: Monster = {
  ...
  legend: [
    "The first sworn deposition concerning Spring-Heeled Jack was sworn before the Lord Mayor of London on the ninth of January 1838 by one Miss Jane Alsop, of Old Ford in Bow. Miss Alsop deposed that a tall thin figure in a dark cloak had presented himself at her gate, claimed to be a policeman in pursuit of a felon, and on her opening to him had vomited blue flame into her face and torn at her dress with metal claws. The same fortnight saw a second sworn deposition, by Miss Lucy Scales of Limehouse, on substantially identical facts. The Lord Mayor referred the matter to the Home Office, which referred it to nobody in particular, and the case became, by default, the property of the press.",
    ...
    "The present author has read the depositions, the broadsheets, the serial, and the reportage. The depositions of January 1838 are reasonably consistent with each other and reasonably similar to the lived experience of a violent assault by an unidentified man in a cloak. Everything else in the file is, in our view, something other than a record of a person.",
  ],
  anxiety: [
  ...
  clinicalNote: {
    ...
    paragraphs: [
      ...
      {
        text: "We mention all of this without dismissing Miss Alsop or Miss Scales, whose depositions in January 1838 are the part of the file we believe. Some person assaulted them. That person, whoever he was, walked away from Bow on his own feet, on the same legs his neighbours had, in cloth his tailor had measured. He could not, on any plausible reading, clear a wall. What cleared the wall was the press.",
        citations: [1, 2, 3],
      },
    ],
    citations: [
