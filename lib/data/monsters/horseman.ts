...
export const horseman: Monster = {
  ...
  audio: {
    ambient: "/audio/horseman-ambient.opus",
    sfx: {
      hooves: "/audio/hoofbeats.webm",
      leaves: "/audio/dry-leaves-wind.webm",
    },
  },
