...
const COPY: Record<Locale, AlienistCopy> = {
  en: {
    ...
    paragraphs: [
      ...
      "The alienist is a fiction. The papers he cites are not, and you may verify any of them yourself.",
  ...
  th: {
    ...
    paragraphs: [
      ...
      "อลีนิสต์เป็นสิ่งสมมุติ แต่บทความที่เขาอ้างอิงหาเป็นเช่นนั้นไม่ และท่านสามารถตรวจสอบได้ด้วยตัวเอง",
      ...
      "ในทางตรงข้าม วรรณกรรมคลินิกที่เขาอ้างอิงนั้นมิได้ถูกประดิษฐ์ขึ้นเพื่อกลวิธีนี้ ทุกบทความที่อลีนิสต์อ้างอิงในเชิงอรรถของเขาสามารถสืบค้นและเข้าถึงได้ มีรายการอยู่ที่หน้า [bibliography] ของตู้นี้ หมายเลข DOI ใช้งานได้ และผู้อ่านที่ประสงค์จะตรวจสอบข้ออ้างใดก็ขอเชิญตามไปดูได้ตามอัธยาศัย เมื่ออลีนิสต์เสนอการสังเคราะห์ — เช่นว่ามนุษย์ของแฟรงเกนสไตน์เป็นกรณีศึกษาของความผูกพันแบบไร้ระเบียบ (disorganised attachment) ว่ามนุษย์หมาป่าตรงกับโรคแสดงตนเป็นหมาป่าทางคลินิก (clinical lycanthropy) ที่บันทึกไว้ ว่าสปริง-ฮีลด์แจ็คเป็นกรณีโรคทางจิตหมู่ในยุคสิ่งพิมพ์ — สิ่งเหล่านี้มิใช่การตีความตามใจตนของอลีนิสต์ แต่คือจุดยืนที่ปรากฏในวรรณกรรมเกี่ยวกับผลงานเหล่านั้น โดยแพทย์และนักวิชาการมนุษยศาสตร์ ซึ่งชื่อปรากฏในรายการอ้างอิง",
    ...
    voiceParas: [
      ...
      "ประการแรก วรรณกรรมนั้นน่าสนใจกว่ารูปแบบบทความมาก การอ่านมนุษย์ของแฟรงเกนสไตน์ผ่านมุมมองความผูกพันไร้ระเบียบ ในต้นฉบับของโบว์ลบีและเอนสเวิร์ธ เป็นงานที่ตื่นเต้นเร้าใจ การทบทวนโรคแสดงตนเป็นหมาป่าทางคลินิกของบลอม ในการสำรวจสิบสามกรณีที่บันทึกไว้อย่างเป็นระบบ เป็นการกระทำที่กล้าหาญทางวิชาการ บทความของโจนาสันและคณะเกี่ยวกับโดเรียน เกรย์ เขียนได้ชัดเจนจนน่าสงสัยว่าผู้นิพนธ์สนุกกับงานนั้น การนำเสนอในระดับเสียงสมัยใหม่ที่ปราศจากชั้นเชิงคือการสูญเสียสิ่งที่ทำให้พวกมันคุ้มค่าแก่การอ่าน",
